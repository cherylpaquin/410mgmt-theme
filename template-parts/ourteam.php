<div class="section-4">
	<div class="container-xxl">
		<div class="row">
			...
			<div id="cards" class="row col-md-12 row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
						...
						<div class="col">
							<div class="card h-100 team-member">
								<div class="row col-sm-12 justify-content-center align-items-center">
									...
									<div class="team-bio col-sm-7">
										<div class="card-body team-info">
											<p> <span class="lead upper"><?php the_sub_field('name'); ?></span><br>
